fun main() {
    val fila: DuplamenteEnfileiravel = FilaEstaticaDupla()
    fila.enfileirarInicio("A")
    println(fila.imprimirFrentePraTras()) //[A]
    println(fila.espiarInicio()) //A
    println(fila.espiarInicio()) //A
